...
#ifndef SIMUL_UTIL_H_INCLUDED
#define SIMUL_UTIL_H_INCLUDED
...
// This parameter should probably rightly be 5, but in CMOD_simDlg::FillComboBox it looks for 
// a blank string ("") which is at PLCMemoryTypes[5] for finding the end of its entries.

#define STATIONTICKBOXESMAX         256 // Total Station Count & max Station Number + 1 (0 - 255 decimal)
