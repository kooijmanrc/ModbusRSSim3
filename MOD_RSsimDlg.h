...
#define STATIONTICKBOXES      52	// Total Station boxes to handle
#define MAX_SCROLLINDEX       4.1	// Was 5 Modified on 2015-07-15 by DL to scroll about 50 stations per click.
#define MAX_SCROLLPAGES		  5		// Max Page # of Station Numbers to Scroll including 0. Added 2015-07-15 by DL

#define PROTOCOL_SELMOD232       0
#define PROTOCOL_SELMODETH       1 // Modbus TCP
#define PROTOCOL_SELMODETH_RTU   2 // Modbus RTU over TCP
#define PROTOCOL_SELAB232        3
#define PROTOCOL_SELABMASTER232  4
...
public:
   ...
   BOOL SetAnalogs(LONG index, WORD value);          // Added 2015-Nov-15 by DL
   BOOL SetCoils(LONG index, WORD value);            // Added 2015-Nov-16 by DL
   BOOL SetInputs(LONG index, WORD value);           // Added 2015-Nov-16 by DL
...
public:
   ...
   void UpdateCharactersReceived() {m_portActivityRX = TRUE;}
   // comms methods
...
public:
   ...
   DWORD m_stopBits;
   DWORD m_rts;
   DWORD m_DataViewFormat;         // Added for Saving Data View Format on 2014-12-30 by DL
...
//   CFont m_Font;  // Added 2017-01-08 by DL for setting main dialog font size
protected:
//   BOOL  m_busyCreatingServers;     // interlocking flag =TRUE during server creation
...
public:
   ...
   afx_msg void OnCopyToClipBoard();
	...
	afx_msg void OnScrollDn();
	afx_msg void OnClearcomms();
	afx_msg void OnShowcommstimeClicked();
	afx_msg void OnShowcommsDecodeClicked();
	...
	afx_msg void OnToggleSaveToFile();
	//}}AFX_MSG
...
public:
   CHTMLOutput m_htmlOutput;
	...
	afx_msg void OnEnChangeServerstats();
