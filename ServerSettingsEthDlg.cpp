	...
	: CDialog(CServerSettingsEthDlg::IDD, pParent)
{
	...
	m_SockTO   = 100;       // 2015-01-30 by DL Changed from "m_localID = 0;"
	m_responseDelay = 0;
	m_linger = FALSE;
	m_numServers = 0;
	m_localIPStr = _T("");
...
void CServerSettingsEthDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_SOCKTO, m_SockTO);           // 2015-01-30 by DL Changed from IDC_LOCALID and m_localID
	DDV_MinMaxUInt(pDX, m_SockTO, 10, 1000);       // 2015-01-30 by DL Changed from m_localID and 9999
