...
//	DISP_FUNCTION(CMyHostProxy, "DisplayAbout", xDisplayAbout, VT_EMPTY, VTS_I4) // Modified 2016-04-15 by DL
...
{
   // do all the range checking
   if ((stationid <0) || (stationid >= STATIONTICKBOXESMAX))   // Added "=" 2016-04-22 by DL
      return;
...
//void CMyHostProxy::xDisplayAbout(long delaytime)   // Modified 2016-04-15 by DL
{
	// TODO: Add your dispatch handler code here
   pGlobalDialog->OnAbout();
//   Sleep(delaytime);   // Modified 2016-04-15 by DL
}
