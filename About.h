...
// Dialog Data
   ...
   //CStaticLink m_hyperlink2;  // modicon						// Deleted 2015-07-26 by DL
...
public:
   ...
   //static void ShowRegistrationMessage(); // Removed 2016-10-22 by DL
   //void RegistrationReminder();           // Removed 2016-10-22 by DL

   // perform the check
   //BOOL CheckRegistrationKey(LPCTSTR name, LPCTSTR key);                          // Removed 2016-10-22 by DL
   //static BOOL CheckRegistrationKey(LPCTSTR name, LPCTSTR key, bool suppressUI);  // Removed 2016-10-22 by DL
