...
// Moved two items below inside programm to be able to dynamically change them based on Windows version by DL on 2015-01-05
// Moved third item below inside program to be able to dynamically change it based on Windows version by DL on 2015-07-15
//#define WIDTH_LISTCOL1  100    // index col width (was 86 but changed for 6-digit addresses on 2014-12-29 by DL)
//#define WIDTH_LISTCOLS   53    // other cols width
//#define WIDTH_LISTCOLBIT 42    // if col is a bit, make it narrower (was 33 DL 2014-12-29)
...
public:
   ...
   void SetupColumns(LONG width, BOOL cloneAddressing, INT ScreenWidth);   // Added ScreenWidth on 2016-08-14 by DL
