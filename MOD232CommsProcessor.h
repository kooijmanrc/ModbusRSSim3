...
#define MOD_READ_EXCEPTION       0x07     // read exception code  // Added 2015-01-13 by DL
#define MOD_READ_DIAGNOSTIC      0x08     // Read Diagnostic Only 00 loopback supported now     // Added 2015-Dec-03 by DL
#define MOD_READ_SLAVEID         0x11     // Report Slave ID (Fakes 984-131 values) // Added 2015-Dec-15 by DL
// writes
...
#define MOD_READWRITE_HOLDING    0x17     // Read and Write Holding registers
// Extended registers
...
public:
   ...
   //static BOOL  LoadRegistersIMP();     // Changed from BOOL to CString on 2016-08-07 by DL
   static CString LoadRegistersIMP();
   //static BOOL  SaveRegistersIMP();     // Changed from BOOL to CString on 2016-08-07 by DL
   static CString SaveRegistersIMP();
...
//   DWORD m_noiseLength;                         // 2015-02-01 by DL Moved into CPP file for sharing with other CPP programs
private:
...
public:
   ...
   BOOL  frameEthernet;
   //BOOL  frameASCII;   // Deleted 2015-Dec-19 by DL because it is not needed
