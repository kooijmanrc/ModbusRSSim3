...
{                                 // Without the changes below the TX and RX are reversed for Modbus TCP/IP Comms display
   ...
   dataDebugOther,
//   dataDebugText,               // Not used so removed by DL on 2015-01-04
...
public:
   ...
   //virtual void SockDataDebugger(const CHAR * buffer, LONG length, dataDebugAttrib att);   // Test on 2015-01-07 by DL
   virtual void SockDataDebugger(const CHAR * buffer, LONG length, dataDebugAttrib att);   // Test on 2015-01-07 by DL
