...
{
   // Per MSDN https://msdn.microsoft.com/en-us/library/t9fb9hww.aspx this is already called by default and is not needed here.
   // UpdateData(TRUE);            // Deleted 2016-08-19 by DL because this caused double error dialogs on out-of-range entries.
   ...
   else                           // Added 2016-08-09 by DL to enable having a Null String for enabling Built-in Animation
	   m_scriptFile = "";         // Added 2016-08-09 by DL to enable having a Null String for enabling Built-in Animation
