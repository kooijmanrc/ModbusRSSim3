         ...
         else
         {
            ...
            switch (rxBuffer[1])
            {
               ...
               case MOD_READ_DIGITALS:
                  ...
                  break;
			   case MOD_READ_SLAVEID:           // Added 2015-Dec-15 by DL
               case MOD_READ_EXCEPTION:			// Added 2015-01-14 by DL
                  raLength = 0;		            // Added 2015-01-14 by DL
                  break;		                // Added 2015-01-14 by DL
