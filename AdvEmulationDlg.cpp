...
void CAdvEmulationDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDV_MinMaxDWord(pDX, m_numInputs, 0, 65536);     // Changed from 65535 on 2015-01-11 by DL
	DDX_Text(pDX, IDC_OUTPUTS, m_numOutputs);
	DDV_MinMaxDWord(pDX, m_numOutputs, 0, 65536);     // Changed from 65535 on 2015-01-11 by DL
	DDX_Text(pDX, IDC_HOLDING, m_numHolding);
	DDV_MinMaxDWord(pDX, m_numHolding, 0, 65536);     // Changed from 65535 on 2015-01-11 by DL
	DDX_Text(pDX, IDC_EXTENDED, m_numExtended);
	DDV_MinMaxDWord(pDX, m_numExtended, 0, 65536);     // Changed from 65535 on 2015-01-11 by DL
	DDX_Text(pDX, IDC_ANALOGS, m_numAnalogs);
	DDV_MinMaxDWord(pDX, m_numAnalogs, 0, 65536);     // Changed from 65535 on 2015-01-11 by DL
...
BOOL CAdvEmulationDlg::OnInitDialog() 
{
   ...
   m_topic.SetHelpTopic("Protocols");  // Added 2015-02-01 by DL to show correct help from Advanced Emulation Dialog
...
void CAdvEmulationDlg::OnMaximum() 
{
	...
	m_numInputs = 65536;             // Changed from 65535 on 2015-01-11 by DL
	m_numOutputs = 65536;            // Changed from 65535 on 2015-01-11 by DL
	m_numHolding = 65536;            // Changed from 65535 on 2015-01-11 by DL
	m_numExtended = 65536;           // Changed from 65535 on 2015-01-11 by DL
	m_numAnalogs = 65536;            // Changed from 65535 on 2015-01-11 by DL
