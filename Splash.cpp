...
CString tempText;
   ...
   AddDrawText(dc, tempText, RGB(255,25,25));   // dark red  // Changed text color from blue to red on 2016-10-22 by DL

   // smaller white text
   dc.SelectObject(m_pFont);

   AddDrawText(dc, "ModRSsim2 is a test utility used to test communications protocol drivers.", RGB(255,255,255));  // white
   AddDrawText(dc, "Originally (c) 1993,2009 Embedded Intelligence Limited"); 
   tempText.Format("WEB: www.sourceforge.net/projects/modrssim2", lpAuthor_email); // WEB Address Updated 2016-04-22 by DL
   AddDrawText(dc, tempText);
   AddDrawText(dc, " ");
   AddDrawText(dc, "This program is free software: you can redistribute it and/or modify it under");
   AddDrawText(dc, "the terms of the GNU General Public License as published by the Free ");
   AddDrawText(dc, "Software Foundation, either version 3 of the License, or (at your option)");
   AddDrawText(dc, "any later version. This program is distributed in the hope");
   AddDrawText(dc, "that it will be useful, but WITHOUT ANY WARRANTY; without even the implied");
   AddDrawText(dc, "warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.");
   AddDrawText(dc, "See the GNU General Public License for more details.");
   //AddDrawText(dc, "");
   AddDrawText(dc, " ");
   ...
   AddDrawText(dc, tempText, RGB(255,25,25));   // dark red // 2015-01-29 by DL was (175,5,5)
